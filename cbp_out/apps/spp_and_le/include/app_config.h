...
// bluetooth standard mesh demo定义
#define SIG_MESH_EN                       0 //单独BLE MESH

#define TRANS_DATA_EN                     0 //蓝牙双模透传
...
#if (SIG_MESH_EN + TRANS_DATA_EN + TRANS_CLIENT_EN + TRANS_AT_COM > 1)
