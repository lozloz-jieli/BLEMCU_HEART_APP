...
#define CFG_BT_LDOTRIM_INFO 0xef
#define TEST_AUTO_BT_OPEN          1   //for test 
...
extern const u8 trans_data_lib_en;//define in libs
static void app_start()
{
	...
	/* log_info("TRANS_DATA_LIB_EN = 1,libs is ok\n"); */
